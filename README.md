...
-  [Fontinical](https://fontinical.com/fonts) - Semantic search over 2,404 free font families by mood and use case, with per-family language coverage computed from required-glyph sets.
